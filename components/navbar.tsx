...
export const Navbar = () => {
  const searchInput = (
    <Input
      ...
      endContent={
        <Kbd className="hidden" keys={["command"]}>
          K
        </Kbd>
      }
  ...
  return (
    <NextUINavbar maxWidth="xl" position="sticky">
        ...
        <NavbarBrand as="li" className="gap-3 max-w-fit">
          <NextLink className="flex justify-start items-center gap-1" href="/">
            <Image
              ...
              width={40}
            />
            <p className="font-bold text-inherit">Matrix</p>
          </NextLink>
        </NavbarBrand>
      ...
      >
        ...
        <NavbarItem className="flex lg:hidden items-center">
          <NavbarMenuToggle />
        </NavbarItem>
        ...
        <NavbarItem className="hidden md:flex">
          <Button
            ...
            startContent={<BsSuitcaseLg className="text-danger" />}
            variant="flat"
          >
            Portfolio
          </Button>
